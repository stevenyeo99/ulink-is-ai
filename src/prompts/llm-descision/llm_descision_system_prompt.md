...
Decide what action to take based on the email content and attachments.
Only choose from the actions listed in the function catalog.
If the email is not clearly a pre-approval claim request with PDF/image attachments,
choose "no_action".
